...
public class ExtFlightDelaysDAO {
	...
	public List<Rotta> getRotte(Map<Integer,Airport> idMap){
		String sql = "SELECT ORIGIN_AIRPORT_ID as id_a1, DESTINATION_AIRPORT_ID AS id_a2, COUNT(*) AS n "
				+ "FROM flights "
		...
		try {
			...
			while(rs.next()) {
				//controllo che siano nella map perchè si può avere db ml fatto che non garantisce sicurezza
